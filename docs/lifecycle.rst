...
.. warning::
    ...
    Expiration, retrying and dead letter supported in ``RabbitMQTransport`` only (**on** by default).
...
Fail
----
Message is failed when a consumer raises any exception or returns negative boolean value (*False*, *None*).
...
| Name              | Default                 | Description                                        |
+===================+=========================+====================================================+
| dead_letter_queue | 'dead_letter\_' + queue | Queue name for dead letter messages.               |
+-------------------+-------------------------+----------------------------------------------------+
